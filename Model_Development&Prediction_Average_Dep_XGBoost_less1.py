...
# -----------------------------------------------------------------------------
INPUT_FILE = r"path/to/input_data_less1.xlsx"  # Path to the input CSV file containing training data
NEW_DATA_FILE = r"path/to/new_data_less1.xlsx"  # Path to the Excel file containing new data for making predictions
PREDICTED_RESULTS_FILE = r"path/to/predicted_results_less1.xlsx"  # Path to save the prediction results
